...
**Roy's Lessons Learned:** Roy's lessons are now integrated into \`site/roys-wisdom.html\` organized by theme (The Paperwork, The Phone Calls, The Meetings, The Money, What I'd Tell Myself on Day One). When Roy adds new lessons, add them to the matching theme section in roys-wisdom. Each lesson is a \`.lesson\` card with: a bold what-happened one-liner (h3), what Roy learned, and a "do this instead" takeaway (the last paragraph gets the yellow background). If a lesson doesn't fit an existing theme, create a new h2 theme section. Roy may rename or reorganize themes freely—follow his lead.
